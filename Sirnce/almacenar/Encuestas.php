...
<div>
    <div class="card">
      <div class="card-header">
        Encuestas del turista Potencial
     </div>
    </div>
    <div class="card-body">
      <div id="tablaDatatable"> </div>
    <a href="<?php echo $urlSitio; ?>almacenar/registrarEncuesta.php" class="btn btn-primary">
    Nueva Encuesta <img class="btn btn-primary" src="../images/agregar.png" alt="">
  </a>
    <br>
    <br>
    <?php  
    include("../almacenar/tabla_E.php");
    ?> 
</div>
<?php 
