                      ...
                      <td style="text-align: center;">
						<span class="btn btn-outline-warning" data-toggle="modal" data-target="#modalEditar" >
							<span >
								 ...
								 ?>
							<a href="<?php echo $urlSitio.'almacenar/actualizarfichaC.php?idFicha='.$idFicha; ?>"> <img src="../images/editar.png" ></a> 
							</span>
						</span>
					</td>
					<td style="text-align: center;">
						<span class="btn btn-outline-danger">
							 <span class="fa fa-trash">
								...
								<a href="<?php echo $urlSitio.'almacenar/borrarfichaC.php?idFicha='.(int)$idFicha; ?>"><img src="../images/eliminar.png" ></a> 						
							</span>					
						</span>
					</td>
					<td style="text-align: center; ">
					  ...
					  <?php 
								 $idFicha = $fichaC['id_ficha_cultural'];
								 ?>
					  <a href="<?php echo $urlSitio.'almacenar/verF_C.php?idFicha='.(int)$idFicha; ?>"><img src="../images/ver.png" alt=""></a>
					  </span>
